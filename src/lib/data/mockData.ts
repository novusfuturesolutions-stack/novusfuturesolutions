...
export const MOCK_JOBS: Job[] = [
  ...
  },
  {
    id: 'job-7',
    companyId: 'comp-nfs',
    companyName: 'EuroTrans & Logistics Sp. z o.o.',
    companyLogo: '/images/nfs-logo.png',
    title: 'Senior Heavy Driver / Class CE Heavy Truck Driver (Jobs in Europe)',
    category: 'Logistics & Supply Chain',
    location: 'Warsaw & Munich (Cross-Border Europe)',
    country: 'Germany / Poland (Europe)',
    city: 'Munich',
    salaryMin: 3200,
    salaryMax: 4800,
    currency: 'EUR',
    ...
    vacancies: 25,
    deadline: '2026-10-15',
    description: 'Special opportunity for Heavy Driver jobs in Europe. Work across Germany, Poland, and the Netherlands. Full visa sponsorship provided for foreign workers and Indian applicants. English speaking work environment with accommodation included.',
    responsibilities: [
      'Operate Class CE heavy trailer trucks on European long-haul routes',
      'Ensure safe transport of commercial cargo following EU tachograph driving rules',
      'Coordinate with English speaking dispatchers and warehouse managers in Europe'
    ],
    requirements: [
      'Valid Heavy Driver / CDL Class CE Driving License (Code 95 qualification support available)',
      'Minimum 3 years heavy driving experience',
      'Basic to conversational English speaking skills (No local European language required)'
    ],
    requiredSkills: ['Heavy Driver', 'Class CE Driving', 'Long-haul Freight', 'English Speaking Europe', 'Tachograph Compliance'],
    requiredLicenses: ['Class CE Heavy Driver License', 'Code 95 Driver Certificate'],
    benefits: ['Visa Sponsorship Provided', 'Company Accommodation Provided', 'Paid Health Insurance in EU', 'Flight Relocation Allowance'],
    visaSponsorship: true,
    accommodationProvided: true,
    foodAllowance: true,
    urgentHiring: true,
  ...
  },
  {
    id: 'job-8',
    companyId: 'comp-nfs',
    companyName: 'Global Fulfillment Europe B.V.',
    companyLogo: '/images/nfs-logo.png',
    title: 'Warehouse Operations Supervisor & Logistics Team Lead',
    category: 'Logistics & Supply Chain',
    ...
    vacancies: 18,
    deadline: '2026-10-20',
    description: 'High-demand Warehouse jobs in Europe. Supervising automated order processing, inbound/outbound freight, and inventory management. Ideal for foreigners and Indian applicants seeking English speaking jobs in Europe with visa sponsorship.',
    responsibilities: [
      'Manage daily warehouse inventory, forklift dispatch, and order fulfillment teams',
      'Ensure compliance with European safety standards and warehouse KPIs',
      'Operate WMS (Warehouse Management System) software in an English-speaking hub'
    ],
    requirements: [
      '2+ years experience in warehouse operations or logistics management',
      'Forklift certification preferred (training provided on site)',
      'Fluent English speaking and communication skills'
    ],
    requiredSkills: ['Warehouse Jobs', 'WMS Software', 'Inventory Control', 'Forklift Operations', 'English Speaking Europe'],
    requiredLicenses: ['Forklift Operator Certification'],
    benefits: ['Full EU Work Permit & Visa Support', 'Housing Assistance', 'Shift Allowances', 'Health Insurance'],
    visaSponsorship: true,
    accommodationProvided: true,
    foodAllowance: false,
    urgentHiring: true,
  ...
  },
  {
    id: 'job-9',
    companyId: 'comp-nfs',
    companyName: 'European Tech & Business Hub',
    companyLogo: '/images/nfs-logo.png',
    title: 'English Speaking Customer Support & Logistics Specialist (Jobs for Foreigners)',
    category: 'Sales & Marketing',
    ...
    vacancies: 15,
    deadline: '2026-11-01',
    description: 'Premier English speaking jobs in Europe for foreigners and candidates from India. Provide international logistics customer service and order updates across Europe.',
    responsibilities: [
      'Handle client inquiries via email, phone, and live chat in English',
      'Track shipment status across European logistics corridors and communicate with heavy drivers',
      'Maintain CRM records and customer satisfaction scores'
    ],
    requirements: [
      'Excellent English speaking and writing skills',
      'Experience in customer support, logistics coordination, or back-office administration',
      'Open to foreigners relocating to Europe with work permit support'
    ],
    requiredSkills: ['English Speaking', 'Customer Support', 'Logistics Coordination', 'CRM Systems', 'Jobs for Indians'],
    requiredLicenses: [],
    benefits: ['EU Blue Card / Visa Sponsorship', 'Relocation Package', 'Health Insurance', 'Career Progression'],
    visaSponsorship: true,
    accommodationProvided: false,
    foodAllowance: false,
    urgentHiring: true,
  ...
  },
  {
    id: 'job-10',
    companyId: 'comp-nfs',
    companyName: 'Euro Logistics Distribution GmbH',
    companyLogo: '/images/nfs-logo.png',
    title: 'Warehouse Forklift Driver & Inventory Associate (Jobs for Indians in Europe)',
    category: 'Logistics & Supply Chain',
    location: 'Hamburg',
    country: 'Germany (Europe)',
    city: 'Hamburg',
    ...
    vacancies: 30,
    deadline: '2026-10-31',
    description: 'Immediate openings for Warehouse jobs in Germany for foreigners & Indian job seekers. Work in modern logistics distribution hubs with visa sponsorship and English speaking team management.',
    responsibilities: [
      'Operate electric reach trucks and forklifts for pallet stacking and unloading',
      'Perform scanning, sorting, and packing of goods for distribution in Europe',
      'Maintain clean, safe, and efficient warehouse working environments'
    ],
    requirements: [
      'Prior warehouse experience or forklift operation',
      'Conversational English speaking skills',
      'Valid passport ready for European visa processing'
    ],
    requiredSkills: ['Warehouse Jobs', 'Forklift Driver', 'Order Packing', 'English Speaking Europe', 'Jobs for Foreigners'],
    requiredLicenses: ['Forklift Operator Card (Optional / Provided)'],
    benefits: ['Visa Sponsorship Provided', 'Accommodation Support', 'Overtime Bonus Pay', 'Medical Insurance'],
    visaSponsorship: true,
    accommodationProvided: true,
    foodAllowance: true,
    urgentHiring: true,
