...
export default function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Even if offline/rules block, present smooth response or fallback message
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-slate-600 text-sm max-w-xl mx-auto leading-relaxed">
            Ask about vacancies, candidate applications, employer hiring tools, or logistics advisory.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          ...
          <div className="md:col-span-5 space-y-6">
            <div className="p-6 rounded-3xl bg-slate-950 text-white border border-slate-800 shadow-xl space-y-6">
              <div className="flex items-center gap-3">
                <img src="/images/nfs-logo.png" alt="NFS" className="w-12 h-12 bg-white rounded-xl p-1 shadow-sm" />
                <div>
                  <div className="font-extrabold text-white text-sm">Novus Future Solutions</div>
                  <div className="text-[10px] text-orange-400 font-mono">Global Logistics Network</div>
                </div>
              </div>
            ...
            <div className="p-6 sm:p-8 rounded-3xl bg-white border border-slate-200/80 shadow-md">
              {submitted ? (
                <div className="text-center py-12 space-y-4">
                  ...
                  <h3 className="text-2xl font-bold text-slate-900">Inquiry Saved to Firebase!</h3>
                  <p className="text-xs text-slate-600 max-w-sm mx-auto">
                    An NFS Corporate Manager will respond to your request within 2 hours.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-4 text-xs">
                  ...
                  <div>
                    ...
                    <div className="relative w-full max-w-full overflow-hidden">
                      <select
                        ...
                        className="w-full max-w-full appearance-none bg-slate-50 border border-slate-200 rounded-xl p-3 pr-10 text-xs font-semibold text-slate-900 focus:outline-none focus:border-blue-600 focus:bg-white transition-colors truncate"
                      >
                        <option value="recruitment">Job Search & Candidate Applications</option>
                        <option value="employer">Employer Hiring Support</option>
                        <option value="logistics">Freight & Logistics Services</option>
                        <option value="growth">Business Growth Advisory</option>
                      </select>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-slate-50 border border-slate-200 rounded-xl p-3 text-slate-900 placeholder-slate-400 focus:outline-none focus:border-blue-600 focus:bg-white transition-colors"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <textarea
                      rows={4}
                      required
                      placeholder="Tell us about the vacancy, application, hiring requirement, or logistics goal..."
                      value={details}
                  ...
                  >
                    {loading ? (
                      ...
                      <>
                        ...
                        <span>Send Message to Firebase</span>
                      </>
                    )}
                  </button>
                </form>
